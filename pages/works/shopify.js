...
import projects from "../../data/shopifyData"
  ...
  return (
    <div className="page-wrapper page-inner">
      <Head>
        ...
        <meta name="description" content="Shopify Projects" />
      ...
      <div className="page">
        ...
        <div className="grid px-[1rem] max-w-[1500px] w-full gap-y-[4rem] lg:gap-x-[3rem] mx-auto text-center lg:grid-cols-3">
